...
\item Kordy et al.~\cite{Kordy2010,Kordy:2012} proposed that attack
  ...
  spirit of Kordy et al.~\cite{Kordy2010} \textbf{can we use a game
    semantics of linear logic to model attack trees?}  This would
  provide the same benefits as their work, but with the resource
  semantics left intact.
