...
\renewcommand{\IATLLdruleTXXvarCName}{\text{id}_{\rhd}}
...
\renewcommand{\IATLLdruleEXXchoiceContName}{\text{cont}_\sqcup}
\renewcommand{\IATLLdruleEXXchoiceSymName}{\text{sym}_\sqcup}
\renewcommand{\IATLLdruleEXXchoiceAssocName}{\text{assoc}_\sqcup}
...
\renewcommand{\IATLLdruleEXXexName}{\text{sym}_\odot}
\renewcommand{\IATLLdruleEXXchoiceName}{\sqcup}
