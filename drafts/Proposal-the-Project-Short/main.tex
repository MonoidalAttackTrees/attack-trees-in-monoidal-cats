...
The following summarizes related work and proposes several open
problems:
\begin{itemize}
...
\item Kordy et al.~\cite{Kordy2010,Kordy:2012} proposed that attack
  ...
  logic a game semantics \cite{?}.  I propose an open problem, in the
  spirit of Kordy et al.~\cite{Kordy2010} can we use a game semantics
  of linear logic to model attack trees?  This would provide the same
  benefits as their work, but with the resource semantics left intact.
...
\item Samarji et al.~\cite{Samarji2013} propose that graph based
  ...
  questions, can one model the situation calculus in first-order
