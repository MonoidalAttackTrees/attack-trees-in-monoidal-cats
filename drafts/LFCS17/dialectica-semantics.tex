...
\begin{lemma}[Non-contractive Equivalence of Attack Trees in the Dialectica Semantics]
...
Modeling full equivalence of attack trees, $[[T1 ~ T2]]$, requires
...
\begin{theorem}[Equivalence of Attack Trees in the Dialectica Semantics]
