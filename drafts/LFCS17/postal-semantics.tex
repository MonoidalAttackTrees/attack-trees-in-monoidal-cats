...
Recall that equivalence of attack trees is defined to be the
...
\begin{lemma}[Joinability is an Equivalence Relation]
...
\begin{lemma}[Equivalence of Attack Trees and Joinability]
