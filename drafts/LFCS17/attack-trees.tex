...
%%   \begin{math}
%%     $$\mprset{flushleft}
%%     \inferrule* [right={\scriptsize $\ATLLdruleEXXparaIName{}$}] {
%%       $$\mprset{flushleft}
%%       \inferrule* [right={\scriptsize $\ATLLdruleEXXseqIName{}$}] {
%%         $$\mprset{flushleft}
%%         \inferrule* [right={\scriptsize $\ATLLdruleEXXvarCName{}$}] {
%%           \,
%%         }{[[A;.;. |- A]]}
%%         \\
%%         $$\mprset{flushleft}
%%         \inferrule* [right={\scriptsize $\ATLLdruleEXXparaIName{}$}] {
%%           $$\mprset{flushleft}
%%           \inferrule* [right={\scriptsize $\ATLLdruleEXXvarName{}$}] {
%%             \,
%%           }{[[.;.;B |- B]]}
%%           \\
%%           $$\mprset{flushleft}
