...
specializations are sound?  We simply define a notion of entailment in
the quaternary semantics.  Denote by $P \leq_4 Q$ the usual natural
number ordering restricted to $\mathsf{4}$.  Then we have the
...
We may now formally define when an attack tree is a sound
...
\begin{lemma}[Properties of Entailment in the Quaternary Semantics]
  ...
  \begin{tabular}{lll}
    ...
    \begin{math}
      \footnotesize
      \begin{array}{lll}
        ((P \odot_4 Q) \rhd_4 (R \odot_4 d)) \leq_4 ((P \rhd_4 R) \odot_4 (Q \rhd_4 d))\\
        ((P \odot_4 Q) \rhd_4 R) \leq_4 (P \odot_4 (Q \rhd_4 R))\\                    
        (P \rhd_4 (Q \odot_4 R)) \leq_4 (Q \odot_4 (P \rhd_4 R))\\
        (P \rhd_4 Q) \leq_4 (P \odot_4 Q)\\          
      \end{array}
    \end{math}      
      \end{tabular}
      & \quad & 
  ...
  \begin{tabular}{lllll}
    \begin{tabular}{lll}
      ...
      \begin{math}
        \footnotesize
        \begin{array}{lll}
          ((P \rhd_4 R) \odot_4 (Q \rhd_4 d)) \leq_4 ((P \odot_4 Q) \rhd_4 (R \odot_4 d))\\
          (P \odot_4 (Q \rhd_4 R)) \leq_4 ((P \odot_4 Q) \rhd_4 R)\\
          \\
          \\
        \end{array}
  ...
  \end{tabular}
\end{lemma}
Each of the above entailments is due to Horne et
