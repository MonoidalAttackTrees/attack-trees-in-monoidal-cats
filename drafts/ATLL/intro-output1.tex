...
seq_node "ATM attack"
  ...
  \end{tabular}  
  \label{fig:atm-tree1}
  \caption{Attack Tree for an ATM attack from Figure~1 Kordy et al.~\cite{Kordy2017} with its corresponding Lina script}
\vspace{-15px}  
\end{figure}
\begin{figure}
  \vspace{-10px}
...
or_node "ATM attack"
  ...
  \end{tabular}  
  \label{fig:atm-tree2}
  \caption{Attack Tree for an ATM attack from Figure~2 of Kordy et
    al.~\cite{Kordy2017} and its corresponding Lina script}
\vspace{-15px}  
\end{figure}
